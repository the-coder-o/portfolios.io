...
export const HeroSection = () => {
  return (
    <div>
      <h2 className="relative z-20 mx-auto max-w-3xl text-center text-base font-normal text-neutral-600 dark:text-neutral-200 md:text-[18px]">
      ...
      <div className="no-visible-scrollbar relative z-20 mb-4 mt-10 flex flex-wrap items-center justify-center gap-4">
        <div className="mr-4 flex items-center space-x-2">
          <span>
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="h-4 w-4 flex-shrink-0 stroke-1 text-neutral-500 md:h-10 md:w-10">
        ...
        <div className="mr-4 flex items-center space-x-2">
          <span>
            <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" className="h-4 w-4 flex-shrink-0 stroke-[0.5px] text-neutral-500 md:h-10 md:w-10" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
