...
export const Header = () => {
  return (
    <>
      <div className="bg-gradient-to-r from-pink-500 via-purple-500 to-indigo-500 px-4 py-1 text-left font-sans text-sm font-medium tracking-tight text-white md:text-center">
        We&apos;re hard at work creating something amazing! Our new website is coming soon, filled with exciting features and fresh content. Stay tuned for updates and get ready to explore a brand-new experience.
      </div>
