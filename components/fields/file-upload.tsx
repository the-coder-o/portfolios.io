                    ...
                    <div key={index} className="group relative mb-5 !h-[100px] !w-[100px] max-w-fit overflow-hidden rounded-xl border shadow-sm">
                      {file?.type?.includes('pdf') ? (
                        ...
                        <div className="relative max-w-md">
                          <Image src={typeof file === 'string' ? `http://178.128.113.232//${file}` : URL.createObjectURL(file)} width={500} height={500} alt="preview" className="mb-5 !h-[100px] !w-[100px] rounded-xl bg-cover object-contain" />
                        </div>
                      )}
