...
export const Timeline = ({ data }: { data: TimelineEntry[] }) => {
  ...
  return (
    <div className="container w-full font-sans" ref={containerRef}>
      <div className="pt-20">
        <h2 className="mb-4 flex max-w-4xl items-center gap-2 text-lg font-medium text-black dark:text-white md:text-4xl">
          Latest updates of - <Logo className="text-2xl" />
        </h2>
      </div>
