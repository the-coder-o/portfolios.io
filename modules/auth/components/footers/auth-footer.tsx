    ...
    <>
      ...
      <div className="mt-10">
        ...
        <div className="mt-6 flex w-full flex-col items-center justify-center gap-2">
          <Button onClick={() => window.open('http://178.128.113.232//api/auth/google/callback')} className="justify-centxl relative z-10 flex h-11 w-full items-center rounded-xl border-2 bg-white px-4 py-1.5 text-sm font-medium text-black transition duration-200 hover:bg-white/80 md:text-sm">
          ...
          <Button onClick={() => window.open('http://178.128.113.232//api/auth/github/callback')} className="justify-centxl relative z-10 flex h-11 w-full items-center rounded-xl border-2 bg-white px-4 py-1.5 text-sm font-medium text-black transition duration-200 hover:bg-white/80 md:text-sm">
