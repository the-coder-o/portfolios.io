...
export const LogoSlider = () => {
  return (
    <div className="no-visible-scrollbar relative z-20 mt-10 flex flex-wrap items-center justify-center gap-4 max-sm:justify-normal">
      <div className="mr-4 flex items-center space-x-2">
        <span>
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="h-6 w-6 flex-shrink-0 stroke-1 text-neutral-500 md:h-10 md:w-10">
      ...
      <div className="mr-4 flex items-center space-x-2">
        <span>
          <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 24 24" className="h-6 w-6 flex-shrink-0 stroke-[0.5px] text-neutral-500 md:h-10 md:w-10" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
