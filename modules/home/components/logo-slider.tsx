    ...
    <div className="mt-5 flex flex-col lg:flex-row lg:items-center">
      <div className="hidden lg:block lg:flex-1">
        <div className="flex items-center gap-8">
          <TechLogo icon={NextIcon} name="Next.js" />
          <TechLogo icon={ReactIcon} name="React" />
          <TechLogo icon={TailwindIcon} name="Tailwind CSS" />
          <TechLogo icon={FramerIcon} name="Framer Motion" />
        </div>
      </div>
    </div>
  )
...
const TechLogo = ({ icon: Icon, name }: { icon: React.ElementType; name: string }) => (
