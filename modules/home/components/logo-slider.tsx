...
export const LogoSlider = () => {
  return (
    <div className="flex items-center justify-center gap-5 max-lg:flex-col max-md:mt-0 max-md:gap-2 max-sm:items-start max-sm:justify-start max-sm:gap-2">
      ...
      <div className="relative mt-[65px] overflow-hidden max-lg:mt-5 max-md:hidden max-sm:w-full">
        <div className="flex items-center gap-6 max-md:flex-wrap">
          ...
          <div className="flex items-center space-x-2">
            <span>
              <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 24 24" className="flex-shrink-0 stroke-[0.5px] text-neutral-500 md:h-10 md:w-10" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
