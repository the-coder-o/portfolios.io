      ...
      {images.map((src, index) => (
        <div key={index} className={index === 0 ? '' : 'hidden md:block'} style={{ height: '100%', width: '100%' }}>
          <OptimizedImage
            ...
            width={500}
            height={500}
            className="h-[200px] rounded-xl bg-cover shadow-[0_0_24px_rgba(34,_42,_53,_0.06),_0_1px_1px_rgba(0,_0,_0,_0.05),_0_0_0_1px_rgba(34,_42,_53,_0.04),_0_0_4px_rgba(34,_42,_53,_0.08),_0_16px_68px_rgba(47,_48,_55,_0.05),_0_1px_0_rgba(255,_255,_255,_0.1)_inset] blur-0 transition duration-300"
          />
        </div>
      ))}
    </Link>
