...
export const HeroSection = () => {
  return (
    <>
      <Spotlight />
      <div className="mt-[120px] flex flex-col gap-3 max-sm:mt-[50px]">
        ...
        <div className="mt-4 flex w-full flex-col items-center justify-center gap-4 px-8 sm:flex-row">
          <Link href="/templates" className="group relative z-20 flex h-10 w-full cursor-pointer items-center justify-center space-x-2 rounded-lg bg-black p-px px-4 py-2 text-center text-sm font-semibold text-white no-underline transition duration-200 dark:bg-white dark:text-black sm:w-52">
            Explore Collection
          </Link>
          <Link
            href="/sign-in"
