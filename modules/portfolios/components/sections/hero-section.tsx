...
export const HeroSection = () => {
  ...
  return (
    <div className="relative mb-[180px] flex flex-col overflow-hidden max-sm:mb-10 sm:items-center sm:text-center">
      <div className="flex flex-col items-center justify-center gap-5 max-md:items-start max-md:gap-0">
        ...
        <p className="relative max-w-4xl text-center text-base font-normal leading-normal text-neutral-600 dark:text-neutral-200 max-md:mb-5 max-sm:text-start md:text-[22px]">
